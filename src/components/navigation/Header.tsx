    ...
    <header className="sticky top-0 z-40 bg-[#0A0A0F]/90 backdrop-blur-xl border-b border-[#27273A]/50">
      <div className="flex items-center justify-between px-5 py-4">
        ...
        >
          ...
          {unreadCount > 0 && (
            <span className="absolute -top-1 -right-1 w-5 h-5 bg-nova-primary text-white text-xs font-bold rounded-full flex items-center justify-center border-2 border-[#0A0A0F]">
              {unreadCount}
            </span>
          )}
        </button>
